...
Current release: **ChatLAN 2.16.14 for Windows x64**

- [Download ChatLAN Setup 2.16.14](https://github.com/azli86/ChatLAN-Releases/releases/download/v2.16.14/ChatLAN.Setup.2.16.14.exe)
- [Download SHA-256 checksum](https://github.com/azli86/ChatLAN-Releases/releases/download/v2.16.14/ChatLAN.Setup.2.16.14.exe.sha256)
- SHA-256: `b17cf27783cf5af041251cd30c0c183cf3418f18785e6a4ba3470d45242bcc43`
...
```powershell
Get-FileHash -Algorithm SHA256 ".\ChatLAN.Setup.2.16.14.exe"
```
