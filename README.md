...
Current release: **ChatLAN 2.14.02 for Windows x64**

- [Download ChatLAN Setup 2.14.02](https://github.com/azli86/ChatLAN-Releases/releases/download/v2.14.02/ChatLAN.Setup.2.14.02.exe)
- [Download SHA-256 checksum](https://github.com/azli86/ChatLAN-Releases/releases/download/v2.14.02/ChatLAN.Setup.2.14.02.exe.sha256)
- SHA-256: `9977d251f9004aa442c603bc4994f7bf25bfe6f0ef3b1b7f859663a22776dcca`
...
```powershell
Get-FileHash -Algorithm SHA256 ".\ChatLAN.Setup.2.14.02.exe"
```
