...
Current release: **ChatLAN 2.16.8 for Windows x64**

- [Download ChatLAN Setup 2.16.8](https://github.com/azli86/ChatLAN-Releases/releases/download/v2.16.8/ChatLAN.Setup.2.16.8.exe)
- [Download SHA-256 checksum](https://github.com/azli86/ChatLAN-Releases/releases/download/v2.16.8/ChatLAN.Setup.2.16.8.exe.sha256)
- SHA-256: `21ffaf4567eddc5184451e11097759807a5bb570b455b92a079758fc24f152fb`
...
```powershell
Get-FileHash -Algorithm SHA256 ".\ChatLAN.Setup.2.16.8.exe"
```
